<?php
	...
	if(isset($_POST) & !empty($_POST)){
		...
		$sql = "UPDATE products SET name='$prodname', description='$description', catid='$category', quantity='$quantity', price='$price', thumb='$filepath' WHERE id = $id";
		...
		<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
			...
			<form method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="productquantity" id="productquantity" placeholder="Quantity" value="<?php echo $r['quantity']; ?>">
			  </div>			  
