				...
				$total = 0;
				 ...
				 ?>
					<tr>
						...
						<td>
							<span class="amount">Rs. <?php echo $cartr['price']; ?></span>					
						</td>
						<td>
							<div class="quantity"><?php echo $value['quantity']; ?></div>
						</td>
						<td>
							<span class="amount">Rs. <?php echo ($cartr['price']*$value['quantity']); ?></span>					
						</td>
					</tr>
				<?php 
				...
				<div class="col-md-6 push-md-6 no-padding">
					...
					<table class="table table-bordered col-md-6">
						<tbody>
							<tr>
								<th>Cart Subtotal</th>
								<td><span class="amount">Rs. <?php echo $total; ?></span></td>
							</tr>
							<tr>
							...
							<tr>
								<th>Order Total</th>
								<td><strong><span class="amount">Rs. <?php echo $total; ?></span></strong> </td>
							</tr>
						</tbody>
					</table>
				</div>
