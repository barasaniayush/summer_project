...
?>
	...
	<section id="content">
		<div class="content-blog content-account">
			...
			<div class="row">
				<div class="col-md-6">
								<h4>My Detail <a href="edit-address.php">Edit</a></h4>
					<?php
						$csql = "SELECT u1.firstname, u1.lastname, u1.address1, u1.city, u.email, u1.mobile FROM users u JOIN usersmeta u1 WHERE u.id=u1.uid AND u.id=$uid";
